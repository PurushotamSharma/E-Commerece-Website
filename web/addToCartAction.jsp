...
int product_total=0;
int cart_total=0;
//Hello What is Your Welcome File From These
...
while(rs.next())
{
            ...
            if(z==0)
            {
            PreparedStatement ps=con.prepareStatement("insert into cart(email,product_id,quantity,price,total, status) values(?,?,?,?,?,?)");
