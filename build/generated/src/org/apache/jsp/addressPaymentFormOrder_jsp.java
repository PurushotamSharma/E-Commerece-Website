...
public final class addressPaymentFormOrder_jsp extends org.apache.jasper.runtime.HttpJspBase
...
total=rs1.getInt(1);
      ...
      out.write("            <th scope=\"col\" style=\"background-color: blanchedalmond;\">Total: <i class=\"fa fa-inr\"></i>");
out.println(total);
      out.write(" </th>\n");
      out.write("          </tr>\n");
      out.write("        </thead>\n");
...
while(rs2.next())
{
      ...
      out.write("        </tbody>\n");
      out.write("      </table>\n");
      out.write("        <form action=\"addressPaymentFormOrderAction.jsp\" method=\"post\">\n");
